...
namespace StarterAssets
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private PlayerSprint sprint;
    ...
    _playerInput = GetComponent<PlayerInput>();
        ...
        private void Update()
        {
            // If climbing system says we're climbing → skip normal movement
        ...
        private void CameraRotation()
        {
            if (_input.look.sqrMagnitude >= _threshold)
            {
                ...
                _cinemachineTargetPitch =
                    Mathf.Clamp(_cinemachineTargetPitch, BottomClamp, TopClamp);
        ...
        private void Move()
        {
            ...
            if (sprint != null)
                targetSpeed = sprint.GetCurrentSpeed();
